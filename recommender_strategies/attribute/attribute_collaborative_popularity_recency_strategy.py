...
class AttributeCollaborativePopularityRecencyStrategy(RecommenderStrategy):
    ...
    @staticmethod
    def recommend_to_user(user_id, user_visits, attribute, attribute_value, time_interval):
        pop_recommendations = PopularityRecommender.get_most_popular_articles_attribute(time_interval, attribute,
                                                                                        attribute_value)
        collab_recommendations = CollaborativeRecommender.recommend_to_user(user_id,
                                                                            AttributeCollaborativePopularityRecencyStrategy.COLLAB_REC_COUNT)
